          ...
          {editingBlog && (
            ...
            >
              ...
              <div className="flex gap-4 mt-4">
                <button
                  type="submit"
                  className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-medium px-5 py-2 rounded-xl shadow-md transition-all duration-200"
                >
                  ✅ Update
                </button>
                <button
                  ...
                  className="flex items-center gap-2 bg-gray-500 hover:bg-gray-600 text-white font-medium px-5 py-2 rounded-xl shadow-md transition-all duration-200"
                >
                  ❌ Cancel
                </button>
              </div>
